...
# Clone the repo
GIT_SSH_COMMAND='ssh -i /home/forge/.ssh/id_deploy' git clone --depth 1 git@github.com:{{ $repository }} {{ $newReleaseName }}
...
cd {{ $currentDir }}
GIT_SSH_COMMAND='ssh -i /home/forge/.ssh/id_deploy' git pull origin master
php artisan config:clear
php artisan cache:clear
php artisan config:cache
sudo supervisorctl restart all
