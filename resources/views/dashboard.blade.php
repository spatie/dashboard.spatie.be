...
<dashboard id="dashboard" columns="5" rows="12">
    ...
    <tasks team-member="Joca" position="c1:c3"></tasks>
    <tasks team-member="Jeffrey" position="c4:c6"></tasks>
    ...
    <time-weather position="e1:e4" date-format="ddd DD/MM" time-zone="America/Lima" weather-city="Lima"></time-weather>
